...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Cliente(nro_documento VARCHAR(40),"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Factura(folio SERIAL PRIMARY KEY,"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Servicio(id_servicio INT PRIMARY KEY,"
    "nombre VARCHAR(100),"
    "capacidad INT,"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Reserva(id_reserva SERIAL PRIMARY KEY,"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Hospedaje(id_servicio INT PRIMARY KEY,"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Cabana(id_servicio INT PRIMARY KEY,"
    "cant_habitaciones INT,"
    "FOREIGN KEY(id_servicio) REFERENCES Servicio(id_servicio));"
)

cur.execute(
    "CREATE TABLE IF NOT EXISTS Lodge(id_servicio INT PRIMARY KEY,"
    "con_tinaja CHAR(3),"
    "FOREIGN KEY(id_servicio) REFERENCES Servicio(id_servicio),"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Empleado(nro_documento VARCHAR(40),"
    "tipo_documento VARCHAR(20),"
    "nombre VARCHAR(100),"
    "correo VARCHAR(50),"
    "telefono VARCHAR(25),"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS PersonalLimpieza(nro_documento VARCHAR(40),"
    "tipo_documento VARCHAR(20),"
    "PRIMARY KEY(nro_documento, tipo_documento),"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS LimpiezaServicio(nro_documento VARCHAR(40),"
    "tipo_documento VARCHAR(20),"
    "id_servicio INT,"
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS Contacto(id_contacto SERIAL PRIMARY KEY,"
    "nombre TEXT,"
    "telefono VARCHAR(25),"
    "descripcion TEXT);"
)
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS PersonalAdministrativo(nro_documento VARCHAR(40),"
    "tipo_documento VARCHAR(20),"
    "PRIMARY KEY (nro_documento, tipo_documento), "
    "FOREIGN KEY (nro_documento, tipo_documento) REFERENCES Empleado(nro_documento, tipo_documento));"
)
...
cur.execute(
    "CREATE TABLE IF NOT EXISTS AdministrativoContacto(id_contacto INTEGER,"
